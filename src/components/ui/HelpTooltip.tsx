        ...
        >
            ...
            {pos && (
                <span
                    ...
                    className="z-[100] pointer-events-none block whitespace-pre-line rounded-lg bg-slate-900 px-3 py-2 text-sm font-normal leading-relaxed text-white shadow-xl"
                >
                    {text}
                </span>
            )}
