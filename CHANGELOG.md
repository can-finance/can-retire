...
- Estate tax and Net Pension no longer each take a column in the year-by-year table.
  Estate tax is a total row at the foot, labelled with the year it falls in — for a
  couple, the year of the *second* death, since the first rolls over to the survivor
  tax-free. Net Pension appears only if someone has a workplace pension.
...
- **The year-by-year table ignored the "Show Today's Dollars" toggle.** The charts,
  ...
  in this table before will be lower when the toggle is on**; ages and percentages
  are unaffected.
